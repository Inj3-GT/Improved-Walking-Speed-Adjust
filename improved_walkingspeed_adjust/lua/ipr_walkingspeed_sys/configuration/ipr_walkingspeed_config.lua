...
if (SERVER) then
    ...
    ipr_WalkSpeed_Config.DrawBar = true --- Affiche la barre de progression (HUD) | Show progress bar
    ipr_WalkSpeed_Config.DrawSpeedPercent = true --- Affiche le pourcentage de vitesse (HUD) | Display speed percentage
    ipr_WalkSpeed_Config.DrawKey = true --- Affiche les touches KEY_CAPSLOCK + Molette (par défaut)(HUD) | Display keys
